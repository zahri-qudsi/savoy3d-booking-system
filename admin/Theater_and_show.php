                ...
                <table class="table table-striped table-sm">
                    ...
                    <tbody id="product_list">
                        <?php
                          ...
                          $result = mysqli_query($conn,"SELECT * FROM theatres");
                        ...
                        <tr>
                            ...
                            <td>
                                <button data-toggle="modal" data-target="#update_show<?php echo $row['id'];?>"
                                    class="btn btn-primary btn-sm">Edit Show</button>
                                <button data-toggle="modal" data-target="#delete_show<?php echo $row['id'];?>"
                                    class="btn btn-danger btn-sm">Delete Show</button>
                            </td>
                        </tr>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="time" class="form-control" name="edit_time"
                                                            id="edit_time" value="<?php echo $row['show_time'];?>"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                        ...
                        <div class="modal fade" id="delete_show<?php echo $row['id'];?>" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="insert_movie" action="insert_data.php" method="post">
                                            <h4> Are you sure to delete this ID"<?php echo $row['id'];?>"?</h4>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="myform" id="insert_movie" action="insert_data.php" method="post"
                        ...
                        <button type="submit" name="addshow" id="addshow" class="btn btn-primary">Submit</button>
                    </form>
                </div>
            </div>
        </div>
