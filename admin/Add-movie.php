                    ...
                    <tbody id="product_list">
                        ...
                        <tr>
                            ...
                            <td><button data-toggle="modal" type="button"
                                    data-target="#edit_movie_modal<?php echo $id;?>" class="btn btn-primary btn-sm">Edit
                                    Movie</button></td>
                            <td><button data-toggle="modal" type="button"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="edit_movie_name"
                                                            id="edit_movie_name"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="edit_directer_name"
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="edit_category"
                                                            id="edit_category" value="<?php echo $row['category']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="edit_language" id="edit_language"
                                                            class="form-control" value="<?php echo $row['language'];?>">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <?php
                                                          ...
                                                          $sql = mysqli_query($conn,"SELECT * FROM theatres");
                                                          if (mysqli_num_rows($sql) > 0) {
                                                            while($fatch = mysqli_fetch_array($sql)) {
                                                              $checked = $fatch['show_time'];
                                                        ?>
                                                        <font size="2"> <?php echo $fatch['show_time'];?></font><input
                                                            type="checkbox" name="show[]" id="show"
                                                            value="<?php echo $fatch['show_time'];?>" <?php
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label>Tailer</label>
                                                        <input type="text" name="edit_tailer" id="edit_tailer"
                                                            class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <?php
                                      ...
                                      if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_array($result)) {
                                          echo '<font size="2">' . $row['show_time'] . '</font><input type="checkbox" name="show[]" value="' . $row['show_time'] . '">';
                                        }
                                      }
                                    ?>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="decription" id="decription" class="form-control"
