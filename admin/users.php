    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <a href="#" data-toggle="modal" data-target="#add_users_modal" class="btn btn-primary btn-sm">Users
                        detail</a>
                </div>
            </div>
                    ...
                    <tbody id="product_list">
                        ...
                        <tr>
                            ...
                            <td><button data-toggle="modal" type="button"
                                    data-target="#edit_users_modal<?php echo $id;?>" class="btn btn-primary btn-sm">Edit
                                    Movie</button>
                                <button data-toggle="modal" type="button"
                                    data-target="#delete_users_modal<?php echo $id;?>"
                                    class="btn btn-danger btn-sm">Delete Movie</button>
                            </td>
                            </td>
                        </tr>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="insert_movie" action="insert_data.php" method="post">
                                            ...
                                            <input type="submit" name="deleteuser" id="deleteuser" value="OK"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="edit_username"
                                                            id="edit_username" value="<?php echo $row['username'];?>">
                                                        <small></small>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label>mobile</label>
                                                        <input type="number" class="form-control" name="edit_mobile"
                                                            id="edit_mobile" value="<?php echo $row['phone']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label>passord</label>
                                                        <input class="form-control" name="edit_password"
                                                            id="edit_password" value="<?php echo $row['password']; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-12">

                                                    <input type="submit" name="updateusers" id="updateusers"
                ...
                <div class="modal-body">
                    <form name="myform" id="insert_movie" action="insert_data.php" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <input type="submit" name="add_user" class="btn btn-primary add-product"
                                    value="Add Product">
                            </div>
                        </div>
                    </form>
